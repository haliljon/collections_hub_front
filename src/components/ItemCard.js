                                ...
                                {toggle && <div class={`card-footer py-3 border-0 bg-${isDarkMode ? 'dark' : ''}`} style={{ backgroundColor: `#f8f9fa` }}>
                                    <div class="d-flex flex-start w-100">
                                        ...
                                        <div class="form-outline w-100 ms-2">
                                            <textarea class={`form-control ${isDarkMode ? 'bg-dark' : ''}`} placeholder={isRussian ? '' : 'Enter your comment'} id="textAreaExample" rows="4" value={commentText} onChange={(e) => setCommentText(e.target.value)}
